# Clawptcha owner-check e2e fixture

This public repository exists to verify that CLAWPTCHA can challenge pull
requests from repository owners, not only first-time contributors.

The important policy is in `.github/clawptcha.yml`:
